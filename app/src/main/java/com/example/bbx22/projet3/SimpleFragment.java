...
public abstract class SimpleFragment extends Fragment {
    ...
    protected BarData generateBarData(int indicePuissance, double[] puissance) {
        ...
        ArrayList<IBarDataSet> sets = new ArrayList<>();
            ...
            for(int j = 0; j < puissance.length ; j++) {
                entries.add(new BarEntry(j, (float) puissance[j]));
            }

            BarDataSet ds = new BarDataSet(entries, "Puissance Turbine " + indicePuissance);
